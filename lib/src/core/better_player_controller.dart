...
class BetterPlayerController extends ChangeNotifier {
  ...
  Future setupDataSource(BetterPlayerDataSource betterPlayerDataSource) async {
      ...
      hlsSubtitles?.forEach((hlsSubtitle) {
        _betterPlayerSubtitlesSourceList.add(
          BetterPlayerSubtitlesSource(
              type: BetterPlayerSubtitlesSourceType.network, name: hlsSubtitle.name, urls: hlsSubtitle.realUrls),
        );
      });
    }
    ...
    final defaultSubtitle =
        _betterPlayerSubtitlesSourceList.firstWhere((element) => element.selectedByDefault == true, orElse: () => null);
